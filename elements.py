"""
elements.py  —  Periodic table data for the Element Quiz cog.

Each entry: {"name": str, "symbol": str, "atomic_number": int}
"""
...
_BY_NAME: dict[str, dict] = {e["name"].lower(): e for e in ELEMENTS}
# Lookup by symbol (case-insensitive)
_BY_SYMBOL: dict[str, dict] = {e["symbol"].lower(): e for e in ELEMENTS}
...
def get_by_symbol(symbol: str) -> dict | None:
    return _BY_SYMBOL.get(symbol.strip().lower())
